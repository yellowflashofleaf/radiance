...
class Register extends Component {
  ...
  formValid = () => {
    ...
    if (
      this.state.isError.contactNumberError !== "" ||
      this.state.isError.passwordError !== "" ||
      this.state.isError.confirmPasswordError !== "" ||
      this.state.isError.emailError !== "" ||
      this.state.isError.collegeError !== "" ||
      this.state.isError.yearError !== ""
    ) {
      isValid = false;
  ...
  formValChange = (e) => {
    ...
    switch (name) {
      ...
      case "year":
        isError.yearError = value === "Year" ? "Please Select Year !!" : "";
        break;
  ...
  onSubmit = async (e) => {
    ...
    if (this.formValid()) {
      const { email, password, fname, lname, year, college, contactNumber } =
        this.state;
      try {
