...
function Navbar() {
    ...
    const getAllNotifications = async () => {
        ...
        try {
            const res = await axios.get(`${process.env.REACT_APP_API_URL}user/notifications`,
                {
                    headers: {
        ...
        <>
            ...
            <div className="nav-bar sticky-top">
                ...
                <div className="login-btn-div">
                    ...
                    {isAuth && user && (
                        <>
                            <div aria-describedby={id} id="notification" style={{
                                borderRadius: "50%",
                                padding: "0.8rem",
                                fontSize: "large",
                                marginRight: "0.5rem"
...

                                {
                                    notifications.map((notif) => (
                                        ...
                                        <div key={notif._id}>
                                            ...
                                            <Dialog onClose={handleDClose} aria-labelledby="customized-dialog-title"
                                                    open={openD} style={{color: "#fff"}}>
